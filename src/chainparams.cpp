...
{
    const char* pszTimestamp = "Hello, from the future.";
...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0xbb228d1848c36671bf1629813b4fbe00af20508b2a78871795a817e97b435110"));
        ...
        vSeeds.emplace_back("dnsseed.fomocointools.com", true);
        vSeeds.emplace_back("dnsseed.fomocoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1513197997, 293345, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.emplace_back("testnet-seed.fomocointools.com", true);
        vSeeds.emplace_back("seed-b.fomocoin.loshan.co.uk", true);
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1296188, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
{
    LogPrintf("!!!!!!!!!!!!!! chainparams - CreateChainParams\n");
...
{
    LogPrintf("!!!!!!!!!!!!!! chainparams - SelectParams\n");
