...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s fomocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  fomocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fomocoin transaction") + "\n" +
              "  fomocoin-tx [options] -create [commands]   " + _("Create hex-encoded fomocoin transaction") + "\n" +
              "\n";
