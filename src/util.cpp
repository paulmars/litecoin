...
const char * const BITCOIN_CONF_FILENAME = "fomocoin.conf";
const char * const BITCOIN_PID_FILENAME = "fomocoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BitcoinFomo";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BitcoinFomo";
#else
    // Unix
    return pathRet / ".fomocoin";
#endif
#endif
}
